...
Reads every run directory under 04_conservative_witness_merging/results/v2_3_1_clean_corpus/ (one per
...
that the unchanged v2.3 CLI's FineWeb run (04_conservative_witness_merging/results/v2_3_conservative/
...
Usage: python3 04_conservative_witness_merging/tools/summarize_clean_corpus.py [04_conservative_witness_merging/results/v2_3_1_clean_corpus]
"""
...
BASELINE = "04_conservative_witness_merging/results/v2_3_conservative/fineweb_baseline/conservative_scaling.csv"
...
def main():
    root = sys.argv[1] if len(sys.argv) > 1 else "04_conservative_witness_merging/results/v2_3_1_clean_corpus"
    scaling, frames = [], []
